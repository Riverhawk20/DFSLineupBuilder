...
public class App implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    private String DYNAMODB_TABLE_NAME_USER = "dfs-lineup-builder-users";
    private String DYNAMODB_TABLE_NAME_LINEUPS = "dfs-lineup-builder-lineups";
    ...
    public APIGatewayProxyResponseEvent handleRequest(final APIGatewayProxyRequestEvent input, final Context context) {
        ...
        try {
            ...
            if(inputParams.containsKey("UserId")){
                int userId = Integer.parseInt(inputParams.get("UserId"));
